...
/**
 * class GoHumanPlayer2
 *
 * This class partially controls the GUI. Additionally, it accepts inputs from the user
 * and updates the game state with each valid input. It follows the same structure as GoHumanPlayer1.
 *
 * @author Lucian Kennelly, Connor Sisourath, Malissa Chen, Colin Miller
 * @date 28 April 2023
 */

public class GoHumanPlayer2 extends GameHumanPlayer implements View.OnTouchListener, View.OnClickListener {
     ...
     * @param: int layoutId
     */
    public GoHumanPlayer2(String name, int layoutId) {
        super(name);
